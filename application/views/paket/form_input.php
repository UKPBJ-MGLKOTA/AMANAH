            ...
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php $attributes = array('id' => 'FormTambahPaket', 'method' => "post", "autocomplete" => "off");
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select <?= form_error('tahun') ? 'is-invalid' : '' ?>" id="tahun" name="tahun">
                                                    <option value="2022" <?php if (set_value('tahun') == "2022") {
                                                                                echo "selected";
                                                                            } ?>>2022</option>
                                                    <option value="2023" <?php if (set_value('tahun') == "2023") {
                                                                                echo "selected";
                                                                            } ?>>2023</option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="nama_paket" class="form-control <?= form_error('nama_paket') ? 'is-invalid' : '' ?>" name="nama_paket" value="<?= set_value('nama_paket') ?>">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" id="pagu" onkeyup="getnumeric(this)" class=" form-control <?= form_error('pagu') ? 'is-invalid' : '' ?>" name="pagu" autocomplete="off" value="<?= form_error('pagu') ? number_format(set_value('pagu'), 2) : '' ?>">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" id="hps" onkeyup="getnumeric(this)" class=" form-control <?= form_error('hps') ? 'is-invalid' : '' ?>" name="hps" autocomplete="off" value="<?= form_error('hps') ? number_format(set_value('hps'), 2) : '' ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select <?= form_error('jenis_pengadaan') ? 'is-invalid' : '' ?>" id="jenis_pengadaan" name="jenis_pengadaan">
                                                    <option value="Pengadaan Barang" <?php if (set_value('jenis_pengadaan') == "Pengadaan Barang") {
                                                                                            echo "selected";
                                                                                        } ?>>Pengadaan Barang</option>
                                                    <option value="Pekerjaan Konstruksi" <?php if (set_value('jenis_pengadaan') == "Pekerjaan Konstruksi") {
                                                                                                echo "selected";
                                                                                            } ?>>Pekerjaan Konstruksi</option>
                                                    <option value="Jasa Konsultansi" <?php if (set_value('jenis_pengadaan') == "Jasa Konsultansi") {
                                                                                            echo "selected";
                                                                                        } ?>>Jasa Konsultansi</option>
                                                    <option value="Jasa Lainnya" <?php if (set_value('jenis_pengadaan') == "Jasa Lainnya") {
                                                                                        echo "selected";
                                                                                    } ?>>Jasa Lainnya</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select <?= form_error('metode_pengadaan') ? 'is-invalid' : '' ?>" id="metode_pengadaan" name="metode_pengadaan">
                                                    <option value="E-purchasing" <?php if (set_value('metode_pengadaan') == "E-purchasing") {
                                                                                        echo "selected";
                                                                                    } ?>>E-purchasing</option>
                                                    <option value="Pengadaan Langsung" <?php if (set_value('metode_pengadaan') == "Pengadaan Langsung") {
                                                                                            echo "selected";
                                                                                        } ?>>Pengadaan Langsung</option>
                                                    <option value="Penunjukan Langsung" <?php if (set_value('metode_pengadaan') == "Penunjukan Langsung") {
                                                                                            echo "selected";
                                                                                        } ?>>Penunjukan Langsung</option>
                                                    <option value="Tender" <?php if (set_value('metode_pengadaan') == "Tender") {
                                                                                echo "selected";
                                                                            } ?>>Tender</option>
                                                    <option value="e-Lelang Cepat" <?php if (set_value('metode_pengadaan') == "e-Lelang Cepat") {
                                                                                        echo "selected";
                                                                                    } ?>>e-Lelang Cepat</option>
                                                    <option value="Seleksi" <?php if (set_value('metode_pengadaan') == "Seleksi") {
                                                                                echo "selected";
                                                                            } ?>>Seleksi</option>
                                                </select>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="lokasi" rows="2" name="lokasi"><?= set_value('lokasi'); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-3 ppkom">
                                                ...
                                                <div class="row g-2">
                                                    <?php if ($this->session->userdata('kd_level') == 2) { ?>
                                                        <div class="col">
                                                            <input type="text" class="form-control <?= form_error('nama_pegawai') ? 'is-invalid' : '' ?>" id="nama_pegawai" name="nama_pegawai" placeholder="Pilih PPKom" value="<?= $profil->nama_pegawai; ?>" disabled>
                                                            <div class="invalid-feedback"><?= form_error('nama_pegawai') ?></div>
                                                            <input type="hidden" id="kd_pegawai" name="kd_pegawai" value="<?= $this->session->userdata('kd_pegawai'); ?>">
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="col">
                                                            <input type="text" class="form-control <?= form_error('nama_pegawai') ? 'is-invalid' : '' ?>" id="nama_pegawai" name="nama_pegawai" placeholder="Pilih PPKom" value="<?= set_value('nama_pegawai'); ?>" disabled>
                                                            <div class="invalid-feedback"><?= form_error('nama_pegawai') ?></div>
                                                            <input type="hidden" id="kd_pegawai" name="kd_pegawai" value="<?= set_value('kd_pegawai') ?>">
                                                        </div>
                                                        <div class="col-auto">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <fieldset class="form-fieldset">
                                                <div class="mb-3 penyedia">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col">
                                                            <input type="text" class="form-control <?= form_error('nama_penyedia') ? 'is-invalid' : '' ?>" id="nama_penyedia" name="nama_penyedia" placeholder="Pilih Penyedia" value="<?= set_value('nama_penyedia'); ?>" disabled>
                                                            <div class="invalid-feedback"><?= form_error('nama_penyedia') ?></div>
                                                            <input type="hidden" name="kd_penyedia" id="kd_penyedia" value="<?= set_value('kd_penyedia'); ?>">
                                                        </div>
                                                        <div class="col-auto">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control <?= form_error('no_kontrak') ? 'is-invalid' : '' ?>" id="no_kontrak" name="no_kontrak" value="<?= set_value('no_kontrak') ?>">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" onkeyup="getnumeric(this)" class=" form-control <?= form_error('nilai_kontrak') ? 'is-invalid' : '' ?>" id="nilai_kontrak" name="nilai_kontrak" autocomplete="off" value="<?= form_error('nilai_kontrak') ? number_format(set_value('nilai_kontrak'), 2) : '' ?>">
                                                        <div class="invalid-feedback"><?= form_error('nilai_kontrak') ?></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label required">Tanggal Kontrak</label>
                                                    <input type="date" class="form-control <?= form_error('tanggal_kontrak') ? 'is-invalid' : '' ?>" id="tanggal_kontrak" name="tanggal_kontrak" value="<?= set_value('tanggal_kontrak'); ?>">
                                                    <div class="invalid-feedback"><?= form_error('tanggal_kontrak') ?></div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label required">Jangka Waktu Pelaksanaan</label>
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control <?= form_error('jangka_waktu') ? 'is-invalid' : '' ?>" id="jangka_waktu" name="jangka_waktu" autocomplete="off" value="<?= set_value('jangka_waktu'); ?>">
                                                        <span class="input-group-text">
                                                            hari
                                                        </span>
