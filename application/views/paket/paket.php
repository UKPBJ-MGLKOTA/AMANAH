        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="<?= base_url('paket/tambah'); ?>" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="<?= base_url('paket/tambah'); ?>" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-report" aria-label="Create new report">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <line x1="12" y1="5" x2="12" y2="19" />
        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header card-header-light">
                            <h3 class="card-title">Paket Pengadaan Barang/Jasa</h3>
                        </div>
                        <div class="card-body">
                            <form id="form-filter">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table class="table datatable tabel-paket table-striped display" id="tabel-paket">
                                <thead>
                                    <tr>
                                        <th class="text-center">No</button></th>
                                        <th class="text-center">Nama Paket</button></th>
                                        <th class="text-center">Pagu (Rp.)</button></th>
                                        <th class="text-center">HPS (Rp.)</button></th>
                                        <th class="text-center">Jenis Pengadaan</button></th>
                                        <th class="text-center">Metode Pengadaan</button></th>
