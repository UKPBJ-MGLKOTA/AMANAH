    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">Anda akan membatalkan Penilaian Kinerja Penyedia ini.</div>
            </div>
...
<script type="text/javascript">
    ...
    table = $('.tabel-kinerja').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('kinerja/ajax_list') ?>",
            "type": "POST",
            "data": function(data) {
                data.satker = $('#satker').val();
                data.jenis_pengadaan = $('#jenis_pengadaan').val();
                data.metode_pengadaan = $('#metode_pengadaan').val();
            }
    ...
    $('.tabel-kinerja').on('click', '.btn-hapus', function() {
        ...
        $('#btn-delete').unbind().click(function() {
            $.ajax({
                ...
                method: 'get',
                async: false,
                url: '<?php echo base_url() ?>kinerja/batal/',
                data: {
                    id: id
                },
                dataType: 'json',
