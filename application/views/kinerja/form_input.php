            ...
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php $attributes = array('id' => 'FormTambahKinerja', 'method' => "post", "autocomplete" => "off");
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3 paket">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col">
                                                        <input type="text" class="form-control <?= form_error('nama_paket') ? 'is-invalid' : '' ?>" id="nama_paket" name="nama_paket" placeholder="Pilih Paket" value="<?= set_value('nama_paket'); ?>" disabled>
                                                        <div class="invalid-feedback"><?= form_error('nama_paket') ?></div>
                                                        <input type="hidden" id="kd_paket" name="kd_paket" value="<?= set_value('kd_paket') ?>">
                                                    </div>
                                                    <div class="col-auto">
                                                        <button type="button" data-toggle="modal" data-target="#modal-paket" class="btn btn-danger btn-icon btn-paket" aria-label="Button">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tahun" name="tahun" value="<?= set_value('tahun'); ?>" disabled>
                                                    <div class="invalid-feedback"><?= form_error('tahun') ?></div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label required">OPD</label>
                                                    <input type="text" class="form-control" id="nama_satker" rows="2" name="nama_satker" value="<?= set_value('nama_satker'); ?>" disabled>
                                                    <input type="hidden" class="kd_satker" id="kd_satker" name="kd_satker" value="<?= set_value('kd_satker'); ?>">
                                                    <div class="invalid-feedback"><?= form_error('nama_satker') ?></div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label required">Lokasi Pekerjaan</label>
                                                    <textarea class="form-control" id="lokasi" rows="3" name="lokasi" disabled><?= set_value('lokasi'); ?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control <?= form_error('jenis_pengadaan') ? 'is-invalid' : '' ?>" id="jenis_pengadaan" name="jenis_pengadaan" value="<?= set_value('jenis_pengadaan') ?>" disabled>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control <?= form_error('metode_pengadaan') ? 'is-invalid' : '' ?>" id="metode_pengadaan" name="metode_pengadaan" value="<?= set_value('metode_pengadaan') ?>" disabled>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 ppkom">
                                                ...
                                                <input type="text" class="form-control <?= form_error('nama_pegawai') ? 'is-invalid' : '' ?>" id="nama_pegawai" name="nama_pegawai" value="<?= set_value('nama_pegawai') ?>" disabled>
                                                <input type="hidden" name="kd_pegawai" id="kd_pegawai" class="kd_pegawai" value="<?= set_value('kd_pegawai') ?>">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <fieldset class="form-fieldset">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="nama_penyedia" class="form-control <?= form_error('nama_penyedia') ? 'is-invalid' : '' ?>" name="nama_penyedia" value="<?= set_value('nama_penyedia') ?>" disabled>
                                                    <input type="hidden" id="kd_penyedia" name="kd_penyedia" value="<?= set_value('kd_penyedia') ?>">
                                                    <div class="invalid-feedback"><?= form_error('nama_penyedia') ?></div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label required">Alamat Penyedia</label>
                                                    <input type="text" id="alamat_penyedia" class="form-control <?= form_error('alamat_penyedia') ? 'is-invalid' : '' ?>" name="alamat_penyedia" value="<?= set_value('alamat_penyedia') ?>" disabled>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control <?= form_error('no_kontrak') ? 'is-invalid' : '' ?>" id="no_kontrak" name="no_kontrak" value="<?= set_value('no_kontrak') ?>" disabled>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control <?= form_error('tanggal_kontrak') ? 'is-invalid' : '' ?>" id="tanggal_kontrak" name="tanggal_kontrak" value="<?= set_value('tanggal_kontrak'); ?>" disabled>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" onkeyup="getnumeric(this)" class=" form-control <?= form_error('nilai_kontrak') ? 'is-invalid' : '' ?>" id="nilai_kontrak" name="nilai_kontrak" autocomplete="off" value="<?= form_error('nilai_kontrak') ? number_format(set_value('nilai_kontrak'), 2) : '' ?>" disabled>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control <?= form_error('jangka_waktu') ? 'is-invalid' : '' ?>" id="jangka_waktu" name="jangka_waktu" autocomplete="off" value="<?= set_value('jangka_waktu'); ?>" disabled>
                                                        <span class="input-group-text">
                                                            hari
                                                        </span>
                                        ...
                                        <table class="table table-vcenter table-bordered table-nowrap card-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_1" id="aspek_1" value="1" onclick="skor_1()">
                                                            Cukup
                                                        </label>
                                                    </td>
                                                    <td class="text-center" rowspan="3">
                                                        <div id="hasil_1">0.00</div>
                                                        <input type="hidden" name="poin_1" id="poin_1">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_1" id="aspek_1" value="2" onclick="skor_1()">
                                                            Baik
                                                        </label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_1" id="aspek_1" value="3" onclick="skor_1()">
                                                            Sangat Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_2" value="1" onclick="skor_2()">
                                                            Cukup
                                                        </label>
                                                    </td>
                                                    <td class="text-center" rowspan="3">
                                                        <div id="hasil_2">0.00</div>
                                                        <input type="hidden" name="poin_2" id="poin_2">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_2" value="2" onclick="skor_2()">
                                                            Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_2" value="3" onclick="skor_2()">
                                                            Sangat Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_3" value="1" onclick="skor_3()">
                                                            Cukup
                                                        </label>
                                                    </td>
                                                    <td class="text-center" rowspan="3">
                                                        <div id="hasil_3">0.00</div>
                                                        <input type="hidden" name="poin_3" id="poin_3">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_3" value="2" onclick="skor_3()">
                                                            Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_3" value="3" onclick="skor_3()">
                                                            Sangat Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_4" value="1" onclick="skor_4()">
                                                            Cukup
                                                        </label>
                                                    </td>
                                                    <td class="text-center" rowspan="3">
                                                        <div id="hasil_4">0.00</div>
                                                        <input type="hidden" name="poin_4" id="poin_4">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-justify text-wrap">
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_4" value="2" onclick="skor_4()">
                                                            Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="form-check form-switch ">
                                                            <input class="form-check-input" type="radio" name="aspek_4" value="3" onclick="skor_4()">
                                                            Sangat Baik
                                                        </label>
                                                    </td>
                                                </tr>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <h4 id="kategori">Belum dinilai</h4>
                                                        <input type="hidden" name="kat" id="kat">
                                                    </td>
                                                    <td class="text-center">
                                                        <h4 id="hasil_akhir">0.00</h4>
                                                        <input type="hidden" name="poin_akhir" id="poin_akhir">
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
